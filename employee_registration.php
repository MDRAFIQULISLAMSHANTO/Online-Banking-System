...
<body>
    ...
    <div class="container">
        ...
        "></div>
            <!-- Background image -->
            <!-- style="
        background-image: url('../mblbank/images/bg-white-emregistration.jpg');" -->
            <div class="card mx-3  mx-md-5 shadow-5-strong" style=" background-image: url('../mblbank/images/bg-white-emregistration.jpg');
        margin-top: -750px;
        ...
        ">
                <div class="card-body py-5 px-md-5">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <h2 class="fw-bold mb-4">Register New Employee</h2>
                            <!--  error message  start-->
                            <?php
                                 if(isset($error)){
